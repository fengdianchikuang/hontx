    ...
    <div>
      ...
      <el-form :label-position="labelPosition" :model="policy" label-width="80px">
        <el-form-item label="保费小计">
          <el-input v-model="policy.premium" :disabled="!changeFlag" @click.native="handleClickPremium"></el-input>
        </el-form-item>
        <el-form-item label="交强险保费">
          <el-input v-model="policy.premiumJq" :disabled="!changeFlag" @click.native="handleClickPremiumJq"></el-input>
        </el-form-item>
        ...
        <div v-show="changeFlag">
          <el-form-item>
            <el-button type="primary" @click="onSubmit">驳回</el-button>
            <el-button type="primary" @click="returnSubmit">下一步(已询价)</el-button>
