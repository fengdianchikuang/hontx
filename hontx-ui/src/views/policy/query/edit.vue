...
<!--          <el-button type="primary" size="mini" icon="el-icon-edit" @click="insertEvent">新增</el-button>-->

          <el-button type="danger" size="mini"  icon="el-icon-delete" @click="deleteEvent">删除</el-button>
        </template>
      </vxe-toolbar>
      <vxe-table
        border
    ...
    <div>
      ...
      <el-form :label-position="labelPosition" :model="policy" label-width="80px">
        <el-form-item label="保费小计">
          <el-input v-model="policy.premium" :disabled="!changeFlag"></el-input>
        </el-form-item>
        <el-form-item label="交强险保费">
          <el-input v-model="policy.premiumJq" :disabled="!changeFlag"></el-input>
        </el-form-item>

        <el-form-item label="车船税">
          <el-input v-model="policy.tax" :disabled="!changeFlag"></el-input>
        </el-form-item>

        <el-form-item label="返回意见">
          <el-input type="textarea" v-model="policy.content" :disabled="!changeFlag"></el-input>
        </el-form-item>

        <el-form-item label="备注">
          <el-input type="textarea" v-model="policy.remark" :disabled="!changeFlag"></el-input>
        </el-form-item>
        <div v-show="changeFlag">
          <el-form-item>
            <el-button type="primary" @click="onSubmit">修改</el-button>
            <el-button type="primary" @click="returnSubmit">下一步(已支付)</el-button>
...
<script>
    ...
    import { getPolicyById,updateQuery } from '@/api/policy/query'
    import { updateInsrnc,addInsrnc,deleteQueryInsrnc } from '@/api/policy/insrnc'
    ...
    export default {
        ...
        methods: {
            ...
            deleteEvent(){
                ...
                const ids = selectRecords.map(o => {
                    return o.qId;
                })
                deleteQueryInsrnc(ids).then(res => {
                  this.handlePolicyById();
                })
            ...
            async insertEvent (row) {
                let record = {
                    queryId: this.tableData[0].queryId != null ? this.tableData[0].queryId : new Date().getTime() + (Math.random() + 1) * Math.pow(10,4) ,
                    insrncCode: '',
                    glassType: '',
                    amount: '',
                    franchiseFlag: '',
             ...
             */
            handlePolicyById(){
                if(this.$route.name === 'queryDetail'){
                    this.changeFlag = false
                }else {
                    this.changeFlag = true
                }
                let id = this.$route.params.queryId
